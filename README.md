...
% brew cask install atom google-chrome google-japanese-ime alfred slack jetbrains-toolbox docker kindle vlc iterm2 marshallofsound-google-play-music-player evernote firefox
```
